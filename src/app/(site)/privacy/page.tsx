    ...
    <div className="min-h-screen bg-white">
      ...
      <main className="max-w-4xl mx-auto px-6 py-16">
        ...
        <div className="text-slate-700 space-y-8 text-base leading-relaxed">
          ...
          <section><h2 className="text-xl font-semibold text-slate-900 mt-8 mb-3">3. Data Security</h2><p>SignProz uses end-to-end encryption, role-based access controls, and audit logging to protect your data. Our infrastructure is designed to meet HIPAA requirements for healthcare-related use cases.</p></section>
